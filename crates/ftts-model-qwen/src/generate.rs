...
/// import and emits the generator-level lines (prefill outputs, per-frame seam hashes).
pub use crate::taps::{install_tap_sink, set_taps_enabled};
use crate::taps::{tap_emit, tap_hash_f32, tap_hash_u32, taps_active};
