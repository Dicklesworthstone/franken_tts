...
const PINNED_DIVERGENCE: &[(&str, f64, usize)] = &[
    ...
    ("codec_decoder.block_01.output", 5.5879354476928711e-6, 333_382),
    ("codec_decoder.block_02.output", 4.7683715820312500e-6, 828_962),
    ("codec_decoder.block_03.output", 2.9802322387695312e-6, 1_588_427),
